...
/* AngeAngeBundle:Utilisateur:edit.html.twig */
class __TwigTemplate_d3ebdd0415babb0e79d53d8febf8e786 extends Twig_Template
{
...
<form action=\"";
        // line 3
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("utilisateur_update", array("id" => $this->getAttribute($this->getContext($context, "entity"), "id"))), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "AngeAngeBundle:Utilisateur:edit.html.twig";
    }
