...
/* AngeAngeBundle:Promotion:edit.html.twig */
class __TwigTemplate_cf35f9a0783eff46b25a6d49b4920af0 extends Twig_Template
{
...
<form action=\"";
        // line 3
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("promotion_update", array("id" => $this->getAttribute($this->getContext($context, "entity"), "id"))), "html", null, true);
        echo "\" method=\"post\" ";
...
";
    ...
    {
        return "AngeAngeBundle:Promotion:edit.html.twig";
    }
