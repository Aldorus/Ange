...
use Ange\AngeBundle\Entity\Matiere;
use Ange\AngeBundle\Form\MatiereType;
...
class MatiereController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AngeAngeBundle:Matiere')->findAll();

        return $this->render('AngeAngeBundle:Matiere:index.html.twig', array(
            'entities' => $entities
        ));
    }
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AngeAngeBundle:Matiere')->find($id);
        ...
        return $this->render('AngeAngeBundle:Matiere:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function newAction()
    {
        ...
        return $this->render('AngeAngeBundle:Matiere:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AngeAngeBundle:Matiere:edit.html.twig', array(
            'entity'      => $entity,
